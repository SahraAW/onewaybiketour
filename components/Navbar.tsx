...
export function Navbar() {
  return <header className="mx-auto flex w-full max-w-7xl items-center justify-between px-5 py-6 md:px-10">
    <Logo />
    <nav className="hidden items-center gap-7 text-[11px] font-bold md:flex">
    ...
    <Link href="/booking/bike" className="text-[11px] font-bold md:hidden">Choose a bike <span className="orange-line">↗</span></Link>
  </header>;
}
