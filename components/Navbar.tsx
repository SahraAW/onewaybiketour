...
export function Navbar() {
  ...
  const menuItems = [{ label: "HOME", href: "/" }, { label: "FIND YOUR MATCH", href: "/onboarding" }, { label: "BIKES", href: "/booking/bike" }, { label: "ROUTES", href: "/tours" }, { label: "CONTACT", href: "mailto:hello@oneway.tours" }];
