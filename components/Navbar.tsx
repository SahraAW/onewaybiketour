...
export function Navbar() {
  ...
  return <header className="relative z-30 mx-auto flex w-full max-w-7xl items-center justify-between gap-2 px-3 py-6 sm:px-5 md:px-10">
    ...
    <div className="ml-auto flex shrink-0 items-center justify-end gap-1 whitespace-nowrap sm:gap-2">
      {pathname !== "/" && <Link href="/onboarding" className="inline-flex min-h-11 items-center justify-center gap-2 rounded-full bg-[var(--orange)] px-2 py-2.5 text-[10px] sm:min-h-12 sm:px-4 sm:text-xs font-semibold text-white transition-colors hover:bg-[#d94f00]">Find your match <span aria-hidden="true">↗</span></Link>}
